...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        // Adjust the initial position and speed of the turtle
        ...
        // Set the color and size of the pen
        bob.penColor("antiquewhite");
        bob.width(3);
        ...
        // Set pen to draw leaf
        // Adjust the initial position for drawing the leaf
        bob.up();
        bob.setPosition(0, 0);
        bob.setDirection(100);
        bob.down();
        bob.speed(10);
        
        // Set the color and size of the pen for drawing the leaf
        bob.penColor("green");
        ...
        for (int i = 0; i < 45; i++) {
            bob.forward(leafSize / 45.0);
            bob.right(2);
            bob.setDirection(160);
        }
        ...
        bob.setPosition(0, -200);
        bob.setDirection(400);
        bob.forward(50);
        

         // Set pen to draw middle flower
        // Adjust the initial position for drawing
        bob.up();
        bob.setPosition(0, 0);
        bob.setDirection(100);
        bob.down();
        ...
        //     bob.left(5);
        //     if(i%10==0)
        //         bob.dot("lavenderblush");
        //     if (i%3 == 0)
        //         bob.penColor("blueviolet");
        //     else if (i%3 == 1)
        //         bob.penColor("lightskyblue");
        //     else
        //         bob.penColor("ivory");
        // }
